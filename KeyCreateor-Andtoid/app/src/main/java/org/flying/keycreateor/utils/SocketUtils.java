        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    String socketAddress ="apkencryptor.beingyi.cn";
                    InetAddress netAddress = InetAddress.getByName(socketAddress);


                    socket = new Socket();
                    socket.connect(new InetSocketAddress(netAddress.getHostAddress(), 6666), 10000);
                    ...
                    writer.writeInt(1);
                    writer.writeUTF(BES.encode(data+key,MD5.encode16(Conf.getSign())));
                    writer.flush();
