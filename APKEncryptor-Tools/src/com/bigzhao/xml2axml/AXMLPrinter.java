...
public class AXMLPrinter {
	...
	public static void decode(InputStream inf) throws XmlPullParserException, IOException {
		...
		AXmlDecoder decode = AXmlDecoder.decode(inf);
		AXmlResourceParser parser = new maobyte.xml.decode.AXmlResourceParser();
		parser.open(new ByteArrayInputStream(decode.getData()), decode.mTableStrings);
