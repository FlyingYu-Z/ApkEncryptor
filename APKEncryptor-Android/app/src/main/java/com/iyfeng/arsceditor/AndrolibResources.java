...
import com.iyfeng.arsceditor.ResDecoder.ARSCDecoder;
import com.iyfeng.arsceditor.ResDecoder.AXMLDecoder;
...
import com.iyfeng.arsceditor.ResDecoder.data.ResValuesFile;
...
final public class AndrolibResources {
	...
	public void decodeARSC(ResTable resTable, ARSCCallBack callback) throws IOException {
		...
		for (ResPackage pkg : resTable.listMainPackages()) {
			...
			System.out.println("Decoding arsc...");
