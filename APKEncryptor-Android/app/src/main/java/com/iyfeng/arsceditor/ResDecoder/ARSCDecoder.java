...
import com.iyfeng.arsceditor.ResDecoder.IO.LEDataInputStream;
import com.iyfeng.arsceditor.ResDecoder.IO.LEDataOutputStream;
import com.iyfeng.arsceditor.ResDecoder.data.ResConfigFlags;
import com.iyfeng.arsceditor.ResDecoder.data.ResID;
import com.iyfeng.arsceditor.ResDecoder.data.ResPackage;
import com.iyfeng.arsceditor.ResDecoder.data.ResResSpec;
import com.iyfeng.arsceditor.ResDecoder.data.ResResource;
import com.iyfeng.arsceditor.ResDecoder.data.ResTable;
import com.iyfeng.arsceditor.ResDecoder.data.ResType;
import com.iyfeng.arsceditor.ResDecoder.data.ResTypeSpec;
import com.iyfeng.arsceditor.ResDecoder.data.value.ResBagValue;
import com.iyfeng.arsceditor.ResDecoder.data.value.ResBoolValue;
import com.iyfeng.arsceditor.ResDecoder.data.value.ResFileValue;
import com.iyfeng.arsceditor.ResDecoder.data.value.ResScalarValue;
import com.iyfeng.arsceditor.ResDecoder.data.value.ResStringValue;
import com.iyfeng.arsceditor.ResDecoder.data.value.ResValue;
import com.iyfeng.arsceditor.ResDecoder.data.value.ResValueFactory;
import com.iyfeng.arsceditor.ResDecoder.data.value.TypedValue;
...
public class ARSCDecoder {
	 ...
	 * 修改后的字符串列表集合
	 ***/
	public byte[] write(InputStream in, List<String> stringlist_src, List<String> stringlist_tar) throws IOException {
	...
	public void replace(String src,String tar){
		mTableStrings.sortStringBlock(src, tar);
	}
